...
\begin{figure}[h!]
  ...
  \label{fig:map_camps}
  \includegraphics[width=0.8\linewidth]{../figures/map7.png}
\end{figure}
...
%        \centering
%        \includegraphics[width=\linewidth]{../figures/map7.1.png}
%        \subcaption{Missing, very small and small camps }
%    \end{minipage}
%    \hfill
%    \begin{minipage}{0.49 \textwidth}
%        \centering
%        \includegraphics[width=\linewidth]{../figures/map7.2.png}
