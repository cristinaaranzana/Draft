...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.6\linewidth]{figures/maps/map_example_methodology.png}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.8\linewidth]{figures/descriptives/bars_camps_sizes.png}
...
\begin{table}[h!]
    \centering
    \caption{Impact of refugee camp exposure on right-wing support}
    \resizebox{0.6\textwidth}{!}{\input{tables/results/political/spatial_results_pvoteD}}
...
\begin{figure}[htbp]
  \centering
  \caption{Impact of refugee camps by size on the socialist vote share}
