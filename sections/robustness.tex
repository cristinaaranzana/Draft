...
\begin{table}[h!]
    ...
    \resizebox{0.4\textwidth}{!}{\input{tables/results/political/synthetic_rings_manual}}
...
\begin{table}[h!]
    \centering
    \caption{Impact of refugee camp exposure on the vote shares - Synthetic DiD with covariates}
    \resizebox{0.4\textwidth}{!}{\input{tables/results/political/rings_sfio_adj}}
    \label{table:table_synthetic}
    \par
        \begin{minipage}{0.4\textwidth}
        \vspace{0.5em}
