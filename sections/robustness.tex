...
\begin{table}[h!]
    ...
    \resizebox{0.4\textwidth}{!}{\input{../tables/results/political/synthetic_rings_combined}}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\linewidth]{../figures/results/political/sdid_event_PCF.png}
  \label{fig:comparison}
    \begin{minipage}{0.7\textwidth}
   \vspace{0.1in} 
   {\tiny Notes: .\par}
...
\input{../tables/results/political/continuos_manual}
