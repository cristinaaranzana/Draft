...
\date{UB-UPF Student Seminar \\ \vspace{0.1in}\\ 30th January 2026}
...
\includegraphics[width=0.6\linewidth]{../figures/maps/map7.png}
\end{figure}
...
\begin{frame}[label=spatial]{Preliminary Results}
...
%% A decline of 2 percentage points from a baseline of 19.4% means to roughly a 10% reduction relative to the pre-treatment level.
\begin{center}
\begin{table}[h!]
\footnotesize
    \caption{Impact of refugee camp exposure on socialist vote share}
     \resizebox{0.65\textwidth}{!}{\input{../tables/results/spatial_results_pvoixSFIO}}
...
\begin{frame}[label=left]{Preliminary Results}

%1920: The PCF (Parti Communiste Français) is created at the Tours Congress when a big part of the SFIO splits to join the 3rd International (Comintern).
%A reduction of 1.5 percentage points from a pretreatment mean of 0.104 (10.4%) implies So the effect represents roughly a 14–15% increase relative to the baseline communist vote share.

\begin{figure}[htbp]
  \centering
  \caption{Impact of Refugee Camp Exposure on socialist vote share by buffer size}
  \includegraphics[width=0.8\linewidth]{../figures/results/pvoixSFIO_all_treatments.png}
  \label{fig:SFIO_all}
...
\begin{frame}[label=communist]{Preliminary Results}

\begin{center}
\begin{table}[h!]
\footnotesize
    \caption{Impact of refugee camp exposure on communist share}
     \resizebox{0.75\textwidth}{!}{\input{../tables/results/spatial_results_pvoixPCF}}
    \begin{minipage}{\textwidth}  % Adjust width here
    \tiny
    \centering 
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\begin{figure}[htbp]
  \centering
  \caption{Impact on the share of votes by type of camp}
  \includegraphics[width=0.8\linewidth]{../figures/results/all_parties_ATT_size_camp.png}
  \label{fig:SFIO_all}
   \begin{minipage}{0.7\textwidth}
   \vspace{0.1in} 
        {\tiny This graph reports the estimates of the event study by buffer. Error bars plot the interval confidence at 95\%. Standard errors are clustered at the department level.\par}
...
\includegraphics[width=\linewidth]{../figures/results/resistance/poisson_dep.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\caption{Poisson regression on number of collaborators}
\includegraphics[width=\linewidth]{../figures/results/resistance/poisson_collabos_dep.png}
\end{minipage}
...
\begin{frame}[label=Buffers]{Buffer - Example}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{../figures/maps/map_example_methodology.png}
  \end{center}
...
\footnotesize
    \caption{Effect of refugee camp exposure on right-wing votes}
     \resizebox{0.7\textwidth}{!}{\input{../tables/results/spatial_results_pvoteD}}
    \begin{minipage}{\textwidth}  % Adjust width here
    \scriptsize
    \centering 
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.6\linewidth]{../figures/descriptives/lnrefugees.png}
  \label{fig:by_region}
   \begin{minipage}{0.7\textwidth}
   \vspace{0.1in} 
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.6\linewidth]{../figures/results/by_region.png}
  \label{fig:by_region}
   \begin{minipage}{0.7\textwidth}
   \vspace{0.1in} 
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.5\linewidth]{../figures/results/occupied.png}
  \label{fig:occupied}
    \begin{minipage}{0.7\textwidth}
   \vspace{0.1in} 
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.5\linewidth]{../figures/results/non_pr.png}
...
\begin{frame}{Distribution number of refugees}

  \begin{center}
    \includegraphics[width=1\textwidth]{../figures/descriptives/Distribution.png}
  \end{center}
