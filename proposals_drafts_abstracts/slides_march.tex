...
\footnotesize
    ...
    \vspace{-2em}
     \resizebox{0.3\textwidth}{!}{\input{tables/results/political/spatial_results_turnout}}
...
\footnotesize
    \caption{Impact of refugee camp exposure on the socialist vote share}
     \resizebox{0.3\textwidth}{!}{\input{tables/results/political/spatial_results_pvoixSFIO}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\footnotesize
    \caption{Impact of refugee camp exposure on the communist vote share}
     \resizebox{0.3\textwidth}{!}{\input{tables/results/political/spatial_results_pvoixPCF}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\linewidth]{figures/results/mobilisation/poisson_count_total.png}
   \begin{minipage}{0.75\textwidth}
   \vspace{0.05in}
        {\tiny Notes: This graph reports the estimates of Poisson regressions on the number of resistants. Error bars plot the interval confidence at 95\%. Standard errors are computed using Conley (1999). Specifications include region fixed effects and controls for surname-based birthplace composition, altitude, mining activity, buildings per capita, average rainfall and 1936 vote shares.\par}
        \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\linewidth]{figures/results/mobilisation/by_size_resistants.png}
   \begin{minipage}{0.75\textwidth}
   \vspace{0.05in}
        {\tiny Notes: This graph reports the estimates of Poisson regressions on the number of resistants by camp size. Error bars plot the interval confidence at 95\%. Standard errors are computed using Conley (1999).\par}
        \end{minipage}
\end{figure}

\end{frame}

\begin{frame}[shrink=15]{Results: Mobilisation}
...
\input{tables/mechanisms/refugees_camps}
...
\footnotesize
    ...
    \vspace{-2em}
     \resizebox{0.3\textwidth}{!}{\input{tables/descriptive/balance_general}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
...
\footnotesize
    \caption{Effect of refugee camp exposure on right-wing votes}
     \resizebox{0.7\textwidth}{!}{\input{tables/results/political/spatial_results_pvoteD}}
...
\footnotesize
    ...
    \vspace{-2em}
     \resizebox{0.3\textwidth}{!}{\input{tables/results/political/synthetic_rings_combined}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth]{figures/results/political/sdid_event_PCF.png}
\end{figure}
\end{column}
\end{columns}
