...
\vspace{-1.5em}
\includegraphics[width=0.55\linewidth]{../../figures/map7.png}
\end{figure}
...
\begin{frame}[label=turnout]{Results: Voting}
...
\footnotesize
    ...
    \vspace{-1em}
     \resizebox{0.4\textwidth}{!}{\input{../../tables/results/political/spatial_results_turnout}}
...
\begin{frame}[label=spatial]{Results: Voting}
...
\footnotesize
    ...
    \vspace{-1em}
     \resizebox{0.4\textwidth}{!}{\input{../../tables/results/political/spatial_results_pvoixSFIO}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\begin{frame}[label=left]{Results: Voting}
...
\footnotesize
    ...
    \vspace{-1em}
     \resizebox{0.4\textwidth}{!}{\input{../../tables/results/political/spatial_results_pvoixPCF}}
    \begin{minipage}{\textwidth}
    \tiny
    \centering
    \item Note: Standard errors (SE) are clustered at the municipality level. \\ *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
...
\begin{frame}[label=event_all]{Results: Voting}

\begin{figure}[htbp]
  \centering
  \caption{Impact of refugee camp exposure on the communist and socialist vote share}
  \includegraphics[width=0.55\linewidth]{../../figures/results/political/event_study_all.png}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \caption{Impact of refugee camp exposure on voting - by size of the camp}
  \includegraphics[width=0.6\linewidth]{../../figures/results/political/effect_size.png}
\end{figure}
...
\begin{frame}{Results: Mobilisation}

\begin{figure}[htbp]
  \centering
  \caption{Effect of refugee camp exposure on resistance, by distance to camp}
  \includegraphics[width=0.5\linewidth]{../../figures/results/resistance/poisson_count_total.png}
   \begin{minipage}{0.5\textwidth}
   \vspace{0.05in}
        {\tiny Notes: This graph reports the estimates of Poisson regressions on the number of resistants. Standard errors are computed using Conley (1999). Specifications include region fixed effects and controls for surname-based birthplace composition, altitude, mining activity, buildings per capita, average rainfall and 1936 vote shares.\par}
        \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \caption{Effect of refugee camp exposure on resistance, by size of camp}
  \includegraphics[width=0.5\linewidth]{../../figures/results/resistance/by_size_resistants.png}
   \begin{minipage}{0.5\textwidth}
   \vspace{0.05in}
        {\tiny Notes: This graph reports the estimates of Poisson regressions on the number of resistants by camp size. Standard errors are computed using Conley (1999).\par}
        \end{minipage}
\end{figure}
...
\footnotesize
    ...
    \vspace{-1em}
     \resizebox{0.5\textwidth}{!}{\input{../../tables/results/political/att_associations_large_medium}}
    \begin{minipage}{0.5\textwidth}
    \tiny
    \centering
    Note: Poisson DiD estimates at the canton level comparing cantons with medium/large refugee camps to those without. Controls include total canton population and 1936 left-wing vote share. Specifications include canton fixed effects and arrondissement $\times$ year fixed effects. *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
    \end{minipage}
\end{table}
\end{center}
...
\item \textbf{Synthetic DiD}:
Results are robust to the synthetic difference-in-differences estimator, which relaxes the parallel trends assumption.
\hyperlink{robustness0}{\beamergotobutton{See results}}
...
\input{../../tables/results/refugees_camps}
...
\begin{frame}[label=Presse1]
  \begin{center}
    \includegraphics[width=0.3\textwidth]{../pictures/presse1.jpg}
  \end{center}
...
\begin{frame}[label=Presse2]
  \begin{center}
    \includegraphics[width=0.3\textwidth]{../pictures/presse3.pdf}
  \end{center}
...
\footnotesize
    ...
    \vspace{-2em}
     \resizebox{0.6\textwidth}{!}{\input{../../tables/descriptive/balance_general}}
    \begin{minipage}{0.6\textwidth}
    \tiny
    \centering
    Note: Absolute standardized differences are below the conventional threshold of 0.25 \citep{ImbensRubin2015}.
    \end{minipage}
\end{table}
\end{center}
...
\begin{frame}[label=Buffers]{Buffer - Example}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{../../figures/map_example_methodology.png}
  \end{center}
...
\begin{frame}[label=Histogram]{Histogram}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{../../figures/mun_exposure.png}
  \end{center}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\linewidth]{../../figures/results/political/pvoixSFIO_event_study.png}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.7\linewidth]{../../figures/results/political/pvoixPCF_event_study.png}
   \begin{minipage}{0.7\textwidth}
   \vspace{0.05in}
        {\tiny This graph reports the estimates of the event study by buffer. Error bars plot the interval confidence at 95\%. Standard errors are clustered at the municipality level.\par}
        \end{minipage}
...
\footnotesize
    \caption{Effect of refugee camp exposure on right-wing votes}
     \resizebox{0.5\textwidth}{!}{\input{../../tables/results/political/spatial_results_pvoteD}}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.4\linewidth]{../../figures/results/political/by_region_sfio.png}
  \label{fig:by_region}
...
\begin{frame}[label=robustness2]{Demarcation Line}
  ...
  \begin{center}
  \includegraphics[width=0.45\textwidth]{../pictures/demarcation.png}
  \end{center}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.4\linewidth]{../../figures/results/political/occupied_sfio.png}
  \label{fig:occupied}
    \begin{minipage}{0.4\textwidth}
   \vspace{0.1in}
   {\tiny \par}
...
\begin{frame}[label=robustness0, shrink=5]{Robustness check: Synthetic DiD}

\begin{center}
\begin{table}[h!]
\footnotesize
    \caption{Impact of refugee camp exposure on vote shares — Synthetic DiD}
     \resizebox{0.5\textwidth}{!}{\input{../../tables/results/political/synthetic_rings_combined}}
    \begin{minipage}{0.5\textwidth}
    \tiny
    \centering
    Note: The table reports synthetic DiD estimates by distance ring. Control group: municipalities within 20--40km. Standard errors obtained via placebo procedure. *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
    \end{minipage}
\end{table}
\end{center}


\hyperlink{robustness0b}{\beamergotobutton{Event study}} \hyperlink{Robustness}{\beamergotobutton{Go back}}

\end{frame}

\begin{frame}[label=robustness0b]{Robustness check: Synthetic DiD — Event study}

\begin{columns}
\begin{column}{0.5\textwidth}
\begin{figure}[htbp]
  \centering
  \caption{Socialist vote share}
  \includegraphics[width=\linewidth]{../../figures/results/political/sdid_event_SFIO.png}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\begin{figure}[htbp]
  \centering
  \caption{Communist vote share}
  \includegraphics[width=\linewidth]{../../figures/results/political/sdid_event_PCF_pop.png}
\end{figure}
\end{column}
\end{columns}

\hyperlink{robustness0}{\beamergotobutton{Table}} \hyperlink{Robustness}{\beamergotobutton{Go back}}
...
\input{../../tables/descriptive/means_votes}
